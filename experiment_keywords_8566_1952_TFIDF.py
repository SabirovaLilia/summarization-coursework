...
#filtered_articles = [i for i in dataset['train'] if 'keyword' in i['abstract'].lower() and i['article'].strip()]
filtered_articles = [i for i in dataset['train'] if ('keyword' in i['abstract'].lower() or 'key word' in i['abstract'].lower()) and i['article'].strip()]
#filtered_articles = [i for i in dataset['train'] if 'key word' in i['abstract'].lower()]
...
for article in filtered_articles:
    ...
    top_n = len(sent_tokenize(abstract))
